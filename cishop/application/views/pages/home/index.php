            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="card-img-top" src="https://placehold.co/50x20" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="card-img-top" src="https://placehold.co/50x20" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="card-img-top" src="https://placehold.co/50x20" alt="Third slide">
                    </div>
                </div>
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <?php foreach ($content as $row) : ?>
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <img src="<?= $row->image ? base_url("/images/product/$row->image") : base_url("/images/product/default.jpg") ?>" alt="" height="" class="card-img-top">
                            <div class="card-body">
                                <h5 class="card-title"><?= $row->product_title ?></h5>
                                <p class="card-text"><strong>Rp<?= number_format($row->price, 0, ',', '.') ?>,-</strong></p>
                                <p class="card-text"><?= $row->description ?></p>
                                <a href="<?= base_url("/shop/category/$row->category_slug") ?>" class="bagde bagde-primary"><i class="fas fa-tags"></i> <?= $row->category_title ?></a>
                            </div>
