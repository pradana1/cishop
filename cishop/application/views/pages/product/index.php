            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <span>Produk</span>
                        <a href="<?= base_url('product/create') ?>" class="btn-secondary btn-sm">Tambah</a>
                        ...
                        <table class="table">
                            ...
                            <?php $no = 0; foreach ($content as $row ) : $no++; ?>
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                        <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/avatar.JPG") ?>" alt="" height="50">
                                        <?= $row->product_title ?>
                                        </p>
                                    </td>
